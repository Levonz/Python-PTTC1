...
def add():
    ...
    dulieu.execute("INSERT INTO quan_ly_nhan_vien.nhanvien(`Name`,Age,Country,Sex,English,Information) VALUES('{}',{},'{}','{}',{},{})".format(name,age,country,sex,english,information))
    ketnoi.commit()
    addVar.set('Đã thêm')
...
def change():
    ...
    if exist == True:
        ...
        english = englishInput.get()
        information = informationInput.get()
        sql ="UPDATE quan_ly_nhan_vien.nhanvien SET `Name` = %s,Age = %s,Country = %s,English = %s,Information = %s WHERE Id = %s"
